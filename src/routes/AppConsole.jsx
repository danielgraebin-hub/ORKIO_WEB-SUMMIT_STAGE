...
import { apiFetch, uploadFile, chat, chatStream, transcribeAudio, getRealtimeClientSecret, startRealtimeSession, startSummitSession, postRealtimeEventsBatch, endRealtimeSession, getRealtimeSession, getSummitSessionScore, submitSummitSessionReview, downloadRealtimeAta as downloadRealtimeAtaFile } from "../ui/api.js";
      ...
      navigator.mediaDevices.getUserMedia({ audio: true, video: false })
        .then(stream => {
          ...
          mr.onstop = async () => {
            ...
            try {
              const result = await transcribeAudio(blob, { token, org: tenant, trace_id: trace });
